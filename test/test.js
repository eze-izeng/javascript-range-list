...
var RangeList = require('../src/model/RangeList').RangeList;
...
describe('RangeList', function() {
  describe('add()', function() {
    ...
    it('Should return: [-999, 999)', function() {
      var rl = new RangeList();
      rl.add([1, 5]);
      rl.add([10, 20]);
      rl.add([20, 20]);
      ...
      rl.add([3, 8]);
      rl.add([-999, 999]);
      assert.strictEqual(rl.toString(), `[-999, 999)`);
    });
  });
  ...
  describe('remove()', function() {
    ...
    it('Should return: ', function() {
      ...
      rl.remove([3, 19]);
      rl.remove([-999, 999]);
      assert.strictEqual(rl.toString(), ``);
    });
  });
});